                        ...
                        <div class="mb-4">
                            <label class="inline-flex items-center">
                                @foreach($permissions as $permission)
                                   <input type="checkbox" value="{{ $permission->id }}" {{ (old('permission')  == 'permission->id') ? 'chaked' : '' }}
                                    id="formEmail" wire:model="permission" class="form-checkbox h-6 w-6 text-green-500">     
